							...
							janus.attach(
								{
									...
									success: function (pluginHandle) {
										...
										$('#videojoin').removeClass('hide').show();		// join room button parent
										$('#registernow').removeClass('hide').show();	// join room button
										$('#register').click(registerUsername);
										$('#username').focus();
										$('#start').removeAttr('disabled').html("Stop")		// register stop button function
											.click(function () {
												$(this).attr('disabled', true);
												janus.destroy();
											});
										$('#subscriberOnly').prop('checked', false);
										$('#subscriberOnly').click(function (event) {
											console.log('subscriberOnly: ', event.target.checked);
											subscriber_mode = event.target.checked;
										});
									},
									error: function (error) {
